...
Profilo di lavoro: alias SSH `github-corp`, chiave `id_ed25519_corp`, identità `user.name` asopranzi e `user.email` asopranzi@intrawelt.com, organizzazione Intrawelt-SaaS. E il profilo con cui questo repository e già configurato.

Profilo personale: alias SSH `github-personal`, chiave `id_ed25519_personal`, identità `user.name` alesop95 e `user.email` alessio.sopranzi.95@gmail.com, utente GitHub alesop95.
